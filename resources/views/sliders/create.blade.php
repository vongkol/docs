        ...
        <div class="card">
            ...
            <div class="card-block">
                @if(Session::has('sms'))
                    ...
                    @endif
                     <form action="{{url('/slider/save')}}" class="form-horizontal" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="file" class="form-control" value="{{old('file_name')}}" id="file_name" name="file_name" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <br>
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control" value="{{old('order')}}" id="order" name="order" required>
                                    </div>
                                </div>
